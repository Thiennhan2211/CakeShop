const StorefrontUtil = {
  ...
  buildNewsArticles() {
    return [
      {
        id: 'cake-house-collection',
        tag: 'Bộ sưu tập mới',
        date: '01.04.2026',
        title: 'Cake House ra mắt dòng bánh kem tone nude hồng dịu',
        summary: 'Những mẫu bánh mới được thiết kế để hợp tiệc sinh nhật, kỷ niệm và các set quà tinh tế.'
      },
      {
        id: 'cake-house-storage',
        tag: 'Mẹo hay',
        date: '30.03.2026',
        title: 'Cách giữ bánh kem đẹp dáng và ngon vị hơn sau khi nhận',
        summary: 'Một vài lưu ý nhỏ về nhiệt độ, thời gian bảo quản và cách di chuyển giúp bánh giữ form tốt hơn.'
      },
      {
        id: 'cake-house-size-guide',
        tag: 'Tư vấn size',
        date: '28.03.2026',
        title: 'Chọn size S, M, L thế nào để vừa đẹp vừa đúng ngân sách',
        summary: 'Hướng dẫn nhanh để chọn size phù hợp theo số người, mục đích buổi tiệc và mức chi tiêu.'
      }
    ];
  }
};
